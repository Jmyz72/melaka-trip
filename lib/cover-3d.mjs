...
const STOPS = [
  { lat: 2.7127, lng: 101.9118, n: 1 }, // Jinbo Dim Sum (Seremban)
  { lat: 2.3083, lng: 102.3060, n: 2 }, // On the road
  { lat: 2.1970, lng: 102.2315, n: 3 }, // Airbnb
  { lat: 2.1969, lng: 102.2313, n: 4 }, // Before dinner (same airbnb)
  { lat: 2.1819, lng: 102.2627, n: 5 }, // Wildseed Cafe
  { lat: 2.1985, lng: 102.2279, n: 6 }, // Loklok
  { lat: 2.1967, lng: 102.2312, n: 7 }  // Late night (back at airbnb)
];
