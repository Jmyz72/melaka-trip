...
export const DAY_START_MIN = {
  1: 15 * 60 + 30, // 3:30 PM (after 3pm check-in)
  2: 8 * 60 + 30,  // 8:30 AM
  3: 7 * 60 + 30   // 7:30 AM
};
...
// Melaka city driving heuristic: ~17 km/h average → ~3.5 min/km, with winding factor.
// Min 2 min between any two stops (parking + walking).
